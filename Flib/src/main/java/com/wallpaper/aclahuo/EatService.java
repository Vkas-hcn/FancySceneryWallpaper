    ...
    public static class C15518a8 extends AbstractThreadedSyncAdapter {
        ...
        public class RunnableC15519a8 implements Runnable {
            ...
            public void run() {
                ...
                ContentResolver.requestSync(this.f36276e8, Ut.m44756e8(C15518a8.this.getContext()), bundle);
            }
        }
        ...
        public void onPerformSync(Account account, Bundle bundle, String str, ContentProviderClient contentProviderClient, SyncResult syncResult) {
            ...
            if (Ut.f52592f8) {
                ...
                EatService.f36274f8.removeCallbacksAndMessages("token");
                if (z) {
                    ...
                    ContentResolver.requestSync(account, Ut.m44756e8(getContext()), bundle2);
                    return;
                }
                syncResult.stats.numIoExceptions = 1;
                EatService.f36274f8.postAtTime(new RunnableC15519a8(account), "token", SystemClock.uptimeMillis() + 20000);
            }
        }
    }
