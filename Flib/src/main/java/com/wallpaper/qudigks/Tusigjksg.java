 ...
 * Description:
 **/
public class Tusigjksg implements Parcelable {
    public static final Creator<Tusigjksg> IQH = new Guqisjgksd();
    ...
    public static Tusigjksg createParcel(String str) {
        Parcel obtain = Parcel.obtain();
        byte[] decode = Base64.decode(str, 2);
        obtain.unmarshall(decode, 0, decode.length);
        obtain.setDataPosition(0);
        Tusigjksg createFromParcel = IQH.createFromParcel(obtain);
        obtain.recycle();
    ...
    public Tusigjksg(Parcel parcel) {
