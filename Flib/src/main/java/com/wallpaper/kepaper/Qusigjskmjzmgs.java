   ...
   static {
       if(Build.VERSION.SDK_INT >= 28) {
           try {
               ...
               Qusigjskmjzmgs.b = (Method)v2.invoke(v0_2, "setHiddenApiExemptions", String[].class);
               Qusigjskmjzmgs.a = v5.invoke(null);
           }
           catch(Throwable v0) {
    ...
    public static boolean a() {
        Object v0 = Qusigjskmjzmgs.a;
        if(v0 != null) {
            Method v2 = Qusigjskmjzmgs.b;
            if(v2 == null) {
                return false;
            }
    ...
    public static boolean b() {
        return Build.VERSION.SDK_INT >= 28 && Qusigjskmjzmgs.a();
    }
