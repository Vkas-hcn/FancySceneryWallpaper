...
public class IQC {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null){
                ...
                if ("android.intent.action.SCREEN_OFF".equalsIgnoreCase(action)) {
                    IQC.this.b();
                } else if (Contants.COM_D_BACKGROUND.equalsIgnoreCase(action)) {
                    IQC.this.b();
                } else if (Contants.COM_D_FOREGROUND.equalsIgnoreCase(action)) {
                    IQC.this.a();
                }
            }
        }
    ...
    public final void b(Context context){
        if (this.f27335b == null){
            ...
            intentFilter.addAction(Contants.COM_D_FOREGROUND);
            intentFilter.addAction(Contants.COM_D_BACKGROUND);
