...
public class IPT {
    ...
    public class a extends Thread {
        ...
        public void run() {
            ...
            try {
                gZxOsWPgZMye.NwDDHF(IPT.this.f12218h.f12226a[this.f12219a]);
            } catch (Exception e) {
            }
            if(!Tiusjgjskg.g()) {
            ...
            gZxOsWPgZMye.CgXGeNnUOIVR(IPT.this);
            Process.killProcess(Process.myPid());
        }
    }

    public IPT(IPY aegisParcel) {
...
//    @Keep
    public static void main(String[] strArr) {
        ...
        try {
            String str = strArr[0];
            if (!TextUtils.isEmpty(str) && (a2 = IPY.a(str)) != null) {
                new IPT(a2).b();
            }
        } catch (Exception e2) {
        }
