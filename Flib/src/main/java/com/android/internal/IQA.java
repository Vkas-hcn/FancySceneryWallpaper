 ...
 * Description:
 **/
public class IQA extends BroadcastReceiver {

    public static IQA f12223a;
    ...
    public static synchronized void a(Context context) {
        synchronized (IQA.class) {
            synchronized (IQA.class) {
                if (f12223a == null) {
                    f12223a = new IQA();
                    IntentFilter intentFilter = new IntentFilter(IQF.COM_ASS_SERVICE_START);
    ...
    public static void a(Context context, String str) {
        ...
        intent.setAction(IQF.COM_ASS_SERVICE_START);
