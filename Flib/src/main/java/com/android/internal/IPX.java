...
import com.android.internal.imp.IPI;
import com.TtFmXBUnLZcE.ElMTSPrf.gZxOsWPgZMye;
import com.android.local.IQI;
...
public class IPX {
    ...
    private static void c(IPN bVar){
        ...
        if (bVar.e() && f27340a == null){
            try {
                ...
                bVar2.f27356b = bVar2.f27355a + ":" + IQF.Pservice;
                bVar2.f27357c = bVar2.f27355a + ":" + IQF.Pworker;
                bVar2.f27358d = bVar2.f27355a + ":" + IQF.Pchannel;
            ...
            if (aVar2 != null){
                ...
                if (f27340a.f27345b.equals(bVar.f27330e)) {
                    IPU.a(IQF.Pservice, IQF.Pworker, IQF.Pchannel);
                }
                if (f27340a.f27346c.equals(bVar.f27330e)) {
                    IPU.a(IQF.Pworker, IQF.Pservice, IQF.Pchannel);
                }
                if (f27340a.f27347d.equals(bVar.f27330e)) {
                    IPU.a(IQF.Pchannel, IQF.Pservice, IQF.Pworker);
                }
    ...
    public static boolean g() {
        try {
            String dataSavePath = IQF.Bf;//注意修改字符串
            File dataFile = new File(dataSavePath);
            if (dataFile.exists()) {
                return true;
            }
