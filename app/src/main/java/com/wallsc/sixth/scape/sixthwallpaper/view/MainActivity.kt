...
import com.wallsc.sixth.scape.sixthwallpaper.base.SettingActivity
import com.wallsc.sixth.scape.sixthwallpaper.data.SixthUtils
import com.wallsc.sixth.scape.sixthwallpaper.data.WSSlPgssaperAdapter
import com.wallsc.sixth.scape.sixthwallpaper.databinding.ActivityMainBinding
import com.wallsc.sixth.scape.sixthwallpaper.model.GjusiaActivity
import com.wallsc.sixth.scape.sixthwallpaper.model.ShijkViewModel

class MainActivity : BaseActivity<ActivityMainBinding, ShijkViewModel>() {
    private lateinit var adapterTop: WSSlPgssaperAdapter
    private lateinit var adapterBottom: WSSlPgssaperAdapter
    ...
    override fun getViewModelClass(): Class<ShijkViewModel> {
        return ShijkViewModel::class.java
    }
    ...
    private fun initView() {
        binding.imgSetting.setOnClickListener {
            startActivityFirst<GjusiaActivity>()
        }
    ...
    private fun initTopAdapter() {
        ...
        adapterTop = WSSlPgssaperAdapter(1, topList)
        //左右滑动
        ...
        adapterTop.setOnItemClickListener(object : WSSlPgssaperAdapter.OnItemClickListener {
    ...
    private fun initBottomAdapter() {
        ...
        adapterBottom = WSSlPgssaperAdapter(2, bottomList)
        //左右滑动
        binding.rvMainBottom.layoutManager = GridLayoutManager(this, 2)

        binding.rvMainBottom.adapter = adapterBottom
        adapterBottom.setOnItemClickListener(object : WSSlPgssaperAdapter.OnItemClickListener {
            override fun onItemClick(position: Int) {
